...
const ReviewDiscussionPage = () => {
  return (
    <div className="flex w-full justify-center items-center flex-col">
      <Tabs aria-label="Dynamic tabs" size="lg" fullWidth className="w-1/2">
              ...
              <CardBody>
                ...
                <div className="mt-3">
                  <p>
                    ...
                    bertahun tahun langganan di toko ini tidak pernah
                    mengecewakan selalu terjaga kualitasnya,sangat rekomendasi
                    toko ini
                  </p>
                </div>
                ...
                <div className="mt-2">
                  <div className="bg-white">
                    <p>
                      ...
                      Iste earum inventore, dolorum eos commodi totam laudantium
                      nesciunt molestiae et atque sint ad iure accusantium
                      provident porro, voluptates nihil est ut tempore maiores
                      minus vel modi? Inventore maxime vitae necessitatibus cum
                      unde, saepe, debitis odit optio quo nostrum, nam
                      laboriosam deserunt.
                    </p>
                  </div>
                  <div className="bg-gray-100 p-3 mt-3 rounded-2xl">
                    ...
                    <div className="ml-20 mt-2">
                      <p>
                        ...
                        elit. Iste earum inventore, dolorum eos commodi totam
                        laudantium nesciunt molestiae et atque sint ad iure
                        accusantium provident porro, voluptates nihil est ut
                        tempore maiores minus vel modi? Inventore maxime vitae
                        necessitatibus cum unde, saepe, debitis odit optio quo
                        nostrum, nam laboriosam deserunt.
                      </p>
                    </div>
